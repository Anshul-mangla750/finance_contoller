...
export function KPICards({ kpis }: Props) {
  const items = [
    {
      ...
      sub: "Total rows processed in the latest run",
      cls: "kpi-slate",
    ...
    },
    {
      ...
      sub: "Auto-matched out of all observed records",
      cls: "kpi-green",
    ...
    },
    {
      ...
      sub: "Confidence in the chosen match path",
      cls: "kpi-blue",
    ...
    },
    {
      ...
      sub: "How many truth links were captured",
      cls: "kpi-purple",
    ...
    },
    {
      ...
      sub: kpis.cash_position < 0 ? "Net outflow pressure" : "Current available liquidity",
      cls: "kpi-amber",
    ...
    },
    {
      ...
      value: kpis.checksum_ok ? "Verified" : "Needs review",
      sub: "Arithmetic check across the current run",
      cls: kpis.checksum_ok ? "kpi-green" : "kpi-red",
      icon: "M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z",
      color: kpis.checksum_ok ? "#10b981" : "#ef4444",
    },
  ];
  ...
  return (
    <div className="metric-grid">
      {items.map((item, i) => (
        <div key={item.label} className={`kpi ${item.cls} anim-fade-up`} style={{ animationDelay: `${i * 60}ms` }}>
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="rounded-2xl border border-white/5 bg-white/5 p-2.5">
              <svg className="h-5 w-5" style={{ color: item.color }} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
